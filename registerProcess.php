...
session_start();
//if the form has been submitted then we can proceed with the registration process
if(isset($_POST['register_btn'])){
    ...
    $gender = $_POST['gender'];
    //gender is an int 1 mean female and 0 means male 
    if ($gender === 'female') {
        $gender = 1;
    } else {
        $gender = 0;
    }
    //use a hash method to encrypt the password
    //use a session to store alerts messages and their type 
